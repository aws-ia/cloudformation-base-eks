...
*Q.* Does this Quick Start install {partner-product-short-name} networking for Kubernetes pods as well as a network policy?

*A.* This Quick Start installs {partner-product-short-name} for a policy only, with networking provided by the Amazon VPC CNI plugin.
